<template>
  <div class="role">
    <div class="top-info">
      <el-form :inline="true" :model="roleForm" class="demo-form-inline">
        <el-form-item label="角色名称：">
          <el-input v-model.trim="roleForm.keyword" placeholder="请输入角色名称"></el-input>
        </el-form-item>
        <el-form-item label="状态：">
          <el-select v-model.trim="roleForm.state" placeholder="请选择状态">
            <el-option
    ...
    >
      ...
      <el-table-column prop="name" label="角色名称" width="130"></el-table-column>
